...
/**
 * @class DenoiseLayer
 * @brief Layer filters noise-induced freestanding obstacles (white costmap pixels) or
...
private:
  /**
     ...
     * (all freestanding obstacles will be preserved, since it satisfies this condition).
